...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.transcribe_button.setGeometry(QtCore.QRect(230, 150, 221, 81))        # Transcribe button
        font = QtGui.QFont()
        font.setPointSize(14)
     ...
     self.transcribe_button.clicked.connect(self.process_and_transcribe_audio)        # progeress bar
        ...
        self.message_label.setGeometry(QtCore.QRect(0, 760, 651, 21))        # Message label (for errors and warnings)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.output_file_name.setGeometry(QtCore.QRect(230, 90, 371, 41))        # Output file name
        font = QtGui.QFont()
        font.setPointSize(14)
        self.output_file_name.setFont(font)
        self.output_file_name.setObjectName("output_file_name")        # Menubar options
 ...
 self.actionOpen_mp4_video_recording.triggered.connect(self.open_audio_file)
     ...
     self.actionOpen_mp4_video_recording.setText(_translate("MainWindow", "Open mp4 video recording"))
        ...
        if file_name[0][-3:] == "mp4":
            ...
            self.message_label.setText("Please select an *.mp4 file")    def convert_mp4_to_wav(self):
        ...
        self.td = total_duration        if len(self.output_file_name.toPlainText()) > 0:
            ...
            self.output_file = "my_speech_file.txt"        # Use thread to process in the background and avoid freezing the GUI
        ...
        msg.exec_()class convertVideoToAudioThread(QThread):
    ...
    def __init__(self, mp4_file_name, audio_file):
        ...
        self.audio_file = audio_file    def __del__(self):
        """Destructor."""
    ...
    def __init__(self, total_duration, audio_file, output_file):
        ...
        self.output_file = output_file    def __del__(self):
        """Destructor."""
        self.wait()    def run(self):
